...
%\input{swdesign/bil/distancesensor/distancesensordesign}
...
%\input{swdesign/bil/distancesensor/distancesensorklasse}
\clearpage
\input{swdesign/bil/data/data}
\clearpage
\input{swdesign/bil/log/log}
\clearpage
\input{swdesign/bil/settings/settings}
\clearpage
\input{swdesign/bil/aks/aks}
\clearpage
\input{swdesign/bil/pccom/pccom}
\clearpage
\input{swdesign/bil/steering/steering}