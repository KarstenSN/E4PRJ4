...
% IBD fremdrift : Vær opmærksom på at forsyningsspændingen til H-broen er defineret på forsyningsdiagrammet. Altså trækker motoren IKKE sin strøm fra signalet motorctrl
