\section{Styretøj servo} \label{sec:hwi_servo}

Til er kontrollere bilens styretøj er der valgt en RC servo. Skolen havde nogle Corona CS238MG \cite{lib:Corona-CS238MG} servoer liggende på lager. Databladet var meget mangelfuld og derfor blev der søgt på Wikipedia \cite{lib:wiki-RC-Servo} for at finde ud af hvordan de virker.
