...
\bibitem {lib:wiringpi} Gordon Henderson: \textit{Wiring Pi - Download and Install}. \\
\url{http://wiringpi.com/download-and-install/}. 14. december 2015.

\bibitem {lib:pi_tools} RASPBERRY PI FOUNDATION: \textit{Værktøjer til crosscompilation på Pi}. \\
\url{https://github.com/raspberrypi/tools}. 14. december 2015.
%TODO ---------------------------------

\bibitem {lib:wiringpi_projekt} WiringPi: \textit{WiringPi - GPIO Interface library for the Raspberry Pi}. \\
