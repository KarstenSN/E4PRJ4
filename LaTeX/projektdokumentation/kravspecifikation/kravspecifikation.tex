...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth - 2 cm]{../fig/diagrammer/systemoversigt.pdf}
...
\subsubsection{Pi}
Systemets kerne er et Raspberry Pi 2 board der kører linux-distributionen XXX %TODO
...
\subsubsection{Servo}
Servo'en har til opgave at omsætte data fra Pi'en til mekanisk styring af bilens forhjul. 

\subsubsection{Afstandssensor}
Bilen har påmonteret 4 afstandssensorer, 2 fremadrettet og 2 bagudrettet. Disse har til formål at indsamle data om eventuelle forhindringer i bilen bane. 

\subsubsection{Accelerometer}
Der er ligeledes påmonteret et accelerometer, til brug ved ændring af hastighed og ????? %TODO

\subsubsection{kamera}
Bilen har påmonteret et kamera som ''realtime'' streamer video til PC'ens skærm så Bruger har mulighed for at navigere på baggrund af visuel feedback. 

\subsubsection{Computer}
''Computeren'' afvikler den software hvorigennem bilen kontrolleres, konfigureres og kalibreres. det er ligeledes igennem computeren at Bruger får visuel feedback fra bilens kamera. 

\subsubsection{Xbox 360 Controller}
Til at kontrollere bilen, benyttes en Xbox 360 controller. vhj. en række trykknapper og styrepinde kan bilens hastighed, såvel som retning bestemmes. 

\subsubsection{Motor}
Motoren omsætter data, herunder regulering fra Pi'en til mekanisk styring af bilens hastighed.

\subsubsection{Tachometer}
Motoren omdrejningshastighed kan via tecometeret aflæses og herefter benyttes til databehandling og regulering. 
\clearpage
...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\textwidth]{../fig/diagrammer/ac_au2.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth - 1 cm]{../fig/diagrammer/uc_au2.pdf} %TODO rettelser ift. Vejledermøde
